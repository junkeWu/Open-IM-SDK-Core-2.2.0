...
func main() {
	...
	case "darwin":
		...
		ws_local_server.InitServer(&sdk_struct.IMConfig{ApiAddr: "http://127.0.0.1:10002",
			WsAddr: "http://127.0.0.1:10001", Platform: utils.OSXPlatformID, DataDir: "./"}) // @junkewu 本地修改
	case "linux":
